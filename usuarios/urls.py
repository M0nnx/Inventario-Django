...
from usuarios.views import InicioSesionView,DesconectarView,PerfilView, RegistroUsuarioView, CustomPasswordChangeView, AgregarDireccion, AgregarPago
...
urlpatterns = [
    ...
    path('perfil/direccion', AgregarDireccion.as_view(), name='perfilDireccion'),
    path('perfil/metodopago', AgregarPago.as_view(), name='perfilPago'),
